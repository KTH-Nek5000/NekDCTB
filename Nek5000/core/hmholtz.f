...
#ifdef AMR
      if (iffdm) call amr_abort('Unsuported for amr, hmholtz')
#endif
...
C
#ifdef AMR
      call dssum_msk (rhs,mask,lx1,ly1,lz1)
#else
...
#ifdef AMR
         call amr_abort('Unsuported for amr, cggo, 1')
#endif
...
#ifdef AMR
         call amr_abort('Unsuported for amr, cggo, 2')
#endif
...
c           call copy(z,r,n)
            call col3(z,r,d,n)
#ifdef AMR
            call amr_h1_proj_msk(z,mask,lx1,ly1,lz1,nel)
#endif
         else                                       ! Schwarz Preconditioner
#ifdef AMR
            call amr_abort('Unsuported for amr, cggo, 3')
#endif
...
c
         ...
         rho0 = rho
         rho  = glsc2(w,p,n)
         call dssum_msk  (w,mask,lx1,ly1,lz1)
#else
