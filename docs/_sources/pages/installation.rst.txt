...
If ``ADIOS2`` has not been compiled, the following message will prompt
...
In this case, after the compilation of ``ADIOS2``, Nek5000 will not
...
``config`` will be added to the ``compile`` sub-directory.
...
`DCTB <https://github.com/KTH-Nek5000/NekDCTB/tree/main/DCTB>`__ and
`examples <https://github.com/KTH-Nek5000/NekDCTB/blob/main/examples/turbPipe/compile/>`__
folder and a description of each parameter can be found following :ref:`casename_par`

To run Nek5000 it is necesary that the ``Nek5000`` executable and the
