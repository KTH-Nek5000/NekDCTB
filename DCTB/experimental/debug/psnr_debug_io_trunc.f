...
c       process. This can be changed in the future.
        call trunc_mfi(fname,1) 
        call copy(vx,vx_hat_trc,nxyze)
        call copy(vy,vy_hat_trc,nxyze)
        call copy(vz,vz_hat_trc,nxyze)
        call copy(pr,pr_hat_trc,nx_pr*nx_pr*nx_pr*nelv)
...
c     apply the operator and get solution in v_hat 
      call filterq(vx_hat,trunc_op,nx,nx,wk1,wk2,trunc_opt,if3d,uumax)
